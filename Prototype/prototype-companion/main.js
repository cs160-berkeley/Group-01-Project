...
let MyButton = Button.template(function($) { return {    left: 0, right: 0, height:30, skin: BlackButtonSkin, 
    ...
    Behavior: class extends ButtonBehavior {
			onTouchEnded(button) {
					trace("tapped\n");			        button.skin = TappedBlueButtonSkin;
			        }
			}, }});
...
let current_layer = 0;let layers = { 0: MusicLayer, 1: SearchLayer, 2: SettingsLayer, 3: PlaylistLayer, 4:CreateNewPlaylistLayer };
